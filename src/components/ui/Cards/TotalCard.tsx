...
export function TotalCard({ listaDeImagenes, shadow, textoTitulo, textoParrafo1, textoParrafo2 }: GaleriaProps) {
    return (
        <Card className={`w-max-400 border border-gray-500/50 ${shadow}`}>
            ...
            <CardHeader>
                ...
                <p className="text-sm ">{textoParrafo1}</p>
                ...
                <div className="relative size-12 left-65" >
                    ...
                    <div className="relative rounded-full right-0 bottom-0">
                        ...
                        <a href="https://github.com/Aguirre2601/Lirios-Atelier">
