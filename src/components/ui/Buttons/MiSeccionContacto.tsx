...
export default function MiSeccionContacto() {
    ...
    const manejarCopiar = () => {
        // Intentar copia directa síncrona mediante API moderna (Evita bloqueos de Safari)
    ...
    return (
        <p className="text-lg md:text-2xl mb-2 md:mb-4 text-transparent bg-clip-text bg-linear-to-br from-gray-100 via-gray-400 to-gray-100 font-satoshi text-center px-2">
            ...
            <button
                ...
                type="button"
                className="text-celeste hover:underline hover:underline-purple-600 pointer-events-auto text-base sm:text-xl font-medium focus:outline-none transition-all duration-300 inline-flex items-center gap-1.5 cursor-pointer"
            >
                {copiado ? (
