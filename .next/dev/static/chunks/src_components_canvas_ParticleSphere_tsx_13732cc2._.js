...
"[project]/src/components/canvas/ParticleSphere.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ParticleSphere() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ParticleSphere.useEffect": ()=>{
            ...
            const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](60, W / H, 0.1, 1000);
            camera.position.z = 3;
            ...
            const createCircleTexture = {
                "ParticleSphere.useEffect.createCircleTexture": ()=>{
            ...
            const onScroll = {
                "ParticleSphere.useEffect.onScroll": ()=>{
            ...
            // ── Mouse (solo desktop) ──────────────────────────────────
            const mouse = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector2"](9999, 9999);
            const onMouseMove = {
                "ParticleSphere.useEffect.onMouseMove": (e)=>{
                    const rect = mount.getBoundingClientRect();
                    mouse.x = (e.clientX - rect.left) / W * 2 - 1;
                    mouse.y = -((e.clientY - rect.top) / H) * 2 + 1;
                }
            }["ParticleSphere.useEffect.onMouseMove"];
            const onMouseLeave = {
                "ParticleSphere.useEffect.onMouseLeave": ()=>mouse.set(9999, 9999)
            }["ParticleSphere.useEffect.onMouseLeave"];
            if (!isMobile) {
            ...
            // ── Resize ────────────────────────────────────────────────
            const onResize = {
                "ParticleSphere.useEffect.onResize": ()=>{
                    const w = mount.clientWidth;
                    const h = mount.clientHeight;
                    camera.aspect = w / h;
            ...
            const mouseWorld = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"]();
            ...
            const animate = {
                "ParticleSphere.useEffect.animate": ()=>{
                    ...
                    for(let i = 0; i < N; i++){
                        ...
                        if (!isMobile) {
                            ...
                            if (hoverStrength > 0.05) {
                                const worldPos = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"](tx, ty, tz).applyEuler(points.rotation);
...
_s(ParticleSphere, "V9/qkEdV8GfsDZk7lMTA1T8g5Ps=");
_c = ParticleSphere;
var _c;
__turbopack_context__.k.register(_c, "ParticleSphere");
...
//# sourceMappingURL=src_components_canvas_ParticleSphere_tsx_13732cc2._.js.map