                    ...
                    <div className="grid place-items-end">
                        <div className="relative size-11 p-2">
                            ...
                            <a
                                ...
                                aria-label={`Visitar el repositorio de GitHub del proyecto ${textoTitulo}`}
                            >
                                {/* Cambiamos el SVG interno roto por un contenedor div con un <img> estándar */}
                                <div 
                                className="w-[37px] h-[37px] border-2 rounded-full border-indigo-600 hover:shadow-xl transition-shadow hover:shadow-indigo-500/50 bg-black shadow-xl shadow-linear-to-br from-indigo-700 via-purple-500 to-cyan-600 flex items-center justify-center overflow-hidden"
                                aria-hidden="true"
                                >
                                <img
                                    src="./Tools/github_dark.svg"
                                    alt="" // Queda vacío porque el enlace ya tiene el aria-label principal
