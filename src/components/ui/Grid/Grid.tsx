...
export default function Grid() {
    ...
    return (
        <div className="grid gap-4 grid-cols-3">
            <div className="col-span-3 rounded-xl p-1 md:p-6 bg-linear-65 from-mauve-950 to-neutral-900 border border-neutral-800   " >
            ...
            <div className="row-span-1 rounded-xl p-1 md:p-6 bg-linear-65 to-neutral-900 from-mauve-950 border border-neutral-800   " >
